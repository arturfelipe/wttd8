...
class SubscribeInvalidPostTest(TestCase):
    def setUp(self):
        data = dict(name='Artur Sousa', cpf='000000000012',
                    email='artur@sousa.net', phone='21-96186180')
        self.resp = self.client.post(r('subscriptions:subscribe'), data)
...
class TemplateRegressionTest(TestCase):
    def test_template_has_non_field_errors(self):
        ...
        invalid_data = dict(name='Artur Sousa', cpf='12345678901')
        resp = self.client.post(r('subscriptions:subscribe'), invalid_data)
        self.assertContains(resp, '<ul class="errorlist">')
